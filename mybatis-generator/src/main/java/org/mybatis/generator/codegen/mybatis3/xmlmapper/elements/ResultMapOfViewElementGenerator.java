 ...
 * 
 */
public class ResultMapOfViewElementGenerator extends
        AbstractXmlElementGenerator {

    public ResultMapOfViewElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id",introspectedTable.getViewResultMapId()));

        String returnType = introspectedTable.getBaseViewModelType();
        ...
        if (!introspectedTable.isConstructorBased()) {
            answer.addAttribute(new Attribute("extends", //$NON-NLS-1$
                introspectedTable.getListResultMapId()));
        }
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable
            ...
            resultElement
                    .addAttribute(new Attribute(
                            "column", MyBatis3FormattingUtilities.getRenamedColumnNameForResultMapOfNotAlis(introspectedColumn))); //$NON-NLS-1$
