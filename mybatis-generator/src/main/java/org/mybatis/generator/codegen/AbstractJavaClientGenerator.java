...
/**
 * This class exists to that Java product generators can specify whether
 * an XML generator is required to match the methods in the
 * Java product.  For example, a Java product built entirely with
