...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_BASE_QUERY_MODEL_TYPE,
        ATTR_BASE_REQUEST_MODEL_TYPE,
        ATTR_BASE_VIEW_MODEL_TYPE,
        ...
        /** used as XML Mapper namespace if no product is generated */
        ...
        ATTR_LIST_RESULT_MAP_ID,
        ATTR_VIEW_RESULT_MAP_ID,
        ...
        ATTR_SQL_QUERY_CONDITION_ID,
        ATTR_SQL_EXISTS_ID,
        ATTR_SQL_FOR_LIST_TV_ID,
        ATTR_SELECT_BY_PRIMERY_ID_FOR_TV_ID,
        ATTR_GET_MAX_BEAN_ID,
        ATTR_GET_COUNT_PAGE_ID,
        ATTR_GET_LIST_BY_BEAN_ID,
        ATTR_IS_EXISTS_ID,
        ATTR_JAVA_SERVICE_TYPE,
        ATTR_JAVA_SERVICE_IMPL_TYPE,
        ATTR_CONSOLE_CONTROLLER_TYPE
    }
    ...
    public String getBaseQueryModelType(){
        return internalAttributes.get(InternalAttribute.ATTR_BASE_QUERY_MODEL_TYPE);
    }
    public String getBaseRequestModelType(){
        return internalAttributes.get(InternalAttribute.ATTR_BASE_REQUEST_MODEL_TYPE);
    }
    public String getBaseViewModelType(){
        return internalAttributes.get(InternalAttribute.ATTR_BASE_VIEW_MODEL_TYPE);
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setListResultMapId("ListResultMap"); //$NON-NLS-1$
        setViewResultMapId("ViewResultMap"); //$NON-NLS-1$
        ...
        setSqlQueryConditionId("query_condition"); //$NON-NLS-1$
        setSqlExistsId("exist_condition"); //$NON-NLS-1$
        setSqlForListTvId("select_for_list_tv"); //$NON-NLS-1$
        setSelectByPrimeryIdForTvSelectId("selectByPrimaryKeyForTv"); //$NON-NLS-1$
        setGetMaxBeanSelectId("getMaxBean"); //$NON-NLS-1$
        setGetCountPageSelectId("getCountPaging"); //$NON-NLS-1$
        setGetListByBeanSelectId("getListByBean"); //$NON-NLS-1$
        setIsExistsSelectId("isExists"); //$NON-NLS-1$
    }
    ...
    public void setListResultMapId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_LIST_RESULT_MAP_ID, s);
    }
    public void setViewResultMapId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_VIEW_RESULT_MAP_ID, s);
    }
    ...
    public String getListResultMapId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_LIST_RESULT_MAP_ID);
    }
    public String getViewResultMapId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_VIEW_RESULT_MAP_ID);
    }
    ...
    public String getSqlQueryConditionId() {
        return internalAttributes.get(InternalAttribute.ATTR_SQL_QUERY_CONDITION_ID);
    }
    public String getSqlExistsId() {
        return internalAttributes.get(InternalAttribute.ATTR_SQL_EXISTS_ID);
    }
    public String getSqlForListTvId() {
        return internalAttributes.get(InternalAttribute.ATTR_SQL_FOR_LIST_TV_ID);
    }
    public String getSelectByPrimeryIdForTvSelectId() {
        return internalAttributes.get(InternalAttribute.ATTR_SELECT_BY_PRIMERY_ID_FOR_TV_ID);
    }
    public String getGetMaxBeanSelectId() {
        return internalAttributes.get(InternalAttribute.ATTR_GET_MAX_BEAN_ID);
    }
    public String getGetCountPageSelectId() {
        return internalAttributes.get(InternalAttribute.ATTR_GET_COUNT_PAGE_ID);
    }
    public String getGetListByBeanSelectId() {
        return internalAttributes.get(InternalAttribute.ATTR_GET_LIST_BY_BEAN_ID);
    }
    public String getIsExistsSelectId() {
        return internalAttributes.get(InternalAttribute.ATTR_IS_EXISTS_ID);
    }
    ...
    protected String calculateJavaConsoleControllerInterfacePackage() {
        JavaConsoleControllerGeneratorConfiguration config = context.getJavaConsoleControllerGeneratorConfiguration();
        if (config == null) {
            return null;
        }
    ...
    protected void calculateJavaClientAttributes() {
        ...
        sb.append(calculateJavaClientInterfacePackage());
        sb.append('.');
        //sb.append(fullyQualifiedTable.getDomainObjectName());//mapperAndServiceFilename
        sb.append(fullyQualifiedTable.getMapperAndServiceFileName());
    ...
    protected void calculateJavaConsoleControllerAttributes() {
        if (context.getJavaConsoleControllerGeneratorConfiguration() == null) {
            return;
        }
        StringBuilder sb = new StringBuilder();
        sb.append(calculateJavaConsoleControllerInterfacePackage());
        sb.append('.');
        //sb.append(fullyQualifiedTable.getDomainObjectName());//mapperAndServiceFilename
        sb.append(fullyQualifiedTable.getMapperAndServiceFileName());
        sb.append("Controller"); //$NON-NLS-1$
        setConsoleControllerType(sb.toString());
    }
    ...
    protected String calculateJavaQueryModelPackage(){
        JavaQueryModelGeneratorConfiguration config = context
                .getJavaQueryModelGeneratorConfiguration();
    ...
    protected String calculateJavaRequestModelPackage(){
        JavaRequestModelGeneratorConfiguration config = context
                .getJavaRequestModelGeneratorConfiguration();
    ...
    protected String calculateJavaViewModelPackage(){
        JavaViewModelGeneratorConfiguration config = context.getJavaViewModelGeneratorConfiguration();
    ...
    protected String calculateQueryModelAttribute(){
        String pakkage = calculateJavaQueryModelPackage();
        StringBuilder sb = new StringBuilder();
        sb.append(pakkage);
        sb.append('.');
        sb.append(fullyQualifiedTable.getQueryModelObjectName());
        setBaseQueryModelType(sb.toString());
        return sb.toString();
    }
    protected String calculateRequestModelAttribute(){
        String pakkage = calculateJavaRequestModelPackage();
        StringBuilder sb = new StringBuilder();
        sb.append(pakkage);
        sb.append('.');
        sb.append(fullyQualifiedTable.getRequestModelObjectName());
        setBaseRequestModelType(sb.toString());
        return sb.toString();
    }
    protected String calculateViewModelAttribute(){
        String pakkage = calculateJavaViewModelPackage();
        StringBuilder sb = new StringBuilder();
        sb.append(pakkage);
        sb.append('.');
        sb.append(fullyQualifiedTable.getViewModelObjectName());
        setBaseViewModelType(sb.toString());
        return sb.toString();
    }
    ...
    protected String calculateSqlMapPackage() {
        ...
        // application can be null if the Java product does not require XML
        if (config != null) {
            sb.append(config.getTargetPackage());
            sb.append(fullyQualifiedTable.getSubPackage(isSubPackagesEnabled(config)));
        }
    ...
    public void setBaseQueryModelType(String baseQueryModelType){
        internalAttributes.put(InternalAttribute.ATTR_BASE_QUERY_MODEL_TYPE,
                baseQueryModelType);
    }
    public void setBaseRequestModelType(String modelType){
        internalAttributes.put(InternalAttribute.ATTR_BASE_REQUEST_MODEL_TYPE,
                modelType);
    }
    public void setBaseViewModelType(String baseViewModelType){
        internalAttributes.put(InternalAttribute.ATTR_BASE_VIEW_MODEL_TYPE,
                baseViewModelType);
    }
    ...
    public String getJavaServiceImplType() {
        return internalAttributes.get(InternalAttribute.ATTR_JAVA_SERVICE_IMPL_TYPE);
    }

    public void setJavaServiceImplType(String javaServiceImplType) {
        internalAttributes.put(InternalAttribute.ATTR_JAVA_SERVICE_IMPL_TYPE,javaServiceImplType);
    }

    public String getConsoleControllerType() {
        return internalAttributes.get(InternalAttribute.ATTR_CONSOLE_CONTROLLER_TYPE);
    }

    public void setConsoleControllerType(String consoleControllerType) {
        internalAttributes.put(InternalAttribute.ATTR_CONSOLE_CONTROLLER_TYPE,consoleControllerType);
    }
    ...
    public String setSqlQueryConditionId(String value) {
        return internalAttributes.put(InternalAttribute.ATTR_SQL_QUERY_CONDITION_ID,value);
    }
    public String setSqlExistsId(String value) {
        return internalAttributes.put(InternalAttribute.ATTR_SQL_EXISTS_ID,value);
    }
    public String setSqlForListTvId(String value) {
        return internalAttributes.put(InternalAttribute.ATTR_SQL_FOR_LIST_TV_ID,value);
    }
    public String setSelectByPrimeryIdForTvSelectId(String value) {
        return internalAttributes.put(InternalAttribute.ATTR_SELECT_BY_PRIMERY_ID_FOR_TV_ID,value);
    }
    public String setGetMaxBeanSelectId(String value) {
        return internalAttributes.put(InternalAttribute.ATTR_GET_MAX_BEAN_ID,value);
    }
    public String setGetCountPageSelectId(String value) {
        return internalAttributes.put(InternalAttribute.ATTR_GET_COUNT_PAGE_ID,value);
    }
    public String setGetListByBeanSelectId(String value) {
        return internalAttributes.put(InternalAttribute.ATTR_GET_LIST_BY_BEAN_ID,value);
    }
    public String setIsExistsSelectId(String value) {
        return internalAttributes.put(InternalAttribute.ATTR_IS_EXISTS_ID,value);
    }
