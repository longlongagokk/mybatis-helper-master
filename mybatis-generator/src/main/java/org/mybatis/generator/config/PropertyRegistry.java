...
public class PropertyRegistry {
    ...
    /**
     * recognized by table and java product generator
     */
    public static final String ANY_ROOT_INTERFACE = "rootInterface"; //$NON-NLS-1$


    public static final String ANY_INPUT_INNER_FIELDS = "inputInnerFields"; //$NON-NLS-1$
    ...
    public static final String MODEL_GENERATOR_SET_IS_BUILDER = "setterIsBuilder"; //$NON-NLS-1$
