...
public class Context extends PropertyHolder {
    ...
    private JavaRequestModelGeneratorConfiguration javaRequestModelGeneratorConfiguration;
    private JavaViewModelGeneratorConfiguration javaViewModelGeneratorConfiguration;
    ...
    private JavaConsoleControllerGeneratorConfiguration javaConsoleControllerGeneratorConfiguration;
    ...
    public JavaRequestModelGeneratorConfiguration getJavaRequestModelGeneratorConfiguration() {
        return javaRequestModelGeneratorConfiguration;
    }

    public void setJavaRequestModelGeneratorConfiguration(JavaRequestModelGeneratorConfiguration javaRequestModelGeneratorConfiguration) {
        this.javaRequestModelGeneratorConfiguration = javaRequestModelGeneratorConfiguration;
    }

    public JavaViewModelGeneratorConfiguration getJavaViewModelGeneratorConfiguration() {
        return javaViewModelGeneratorConfiguration;
    }

    public void setJavaViewModelGeneratorConfiguration(JavaViewModelGeneratorConfiguration javaViewModelGeneratorConfiguration) {
        this.javaViewModelGeneratorConfiguration = javaViewModelGeneratorConfiguration;
    }
    ...
    public JavaConsoleControllerGeneratorConfiguration getJavaConsoleControllerGeneratorConfiguration() {
        return javaConsoleControllerGeneratorConfiguration;
    }

    public void setJavaConsoleControllerGeneratorConfiguration(JavaConsoleControllerGeneratorConfiguration javaConsoleControllerGeneratorConfiguration) {
        this.javaConsoleControllerGeneratorConfiguration = javaConsoleControllerGeneratorConfiguration;
    }
    ...
    public XmlElement toXmlElement() {
        ...
        if(javaQueryModelGeneratorConfiguration != null){
            xmlElement.addElement(javaQueryModelGeneratorConfiguration.toXmlElement());
        }
        ...
        if (javaConsoleControllerGeneratorConfiguration != null) {
            xmlElement.addElement(javaConsoleControllerGeneratorConfiguration.toXmlElement());
        }
