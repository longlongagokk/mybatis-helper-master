...
public abstract class BaseRules implements Rules {
    ...
    /**
     * if has view then response this
     * @return
     */
    public boolean generateListResultMap(){
        if(isModelOnly){
            return true;
        }
        return stringHasValue(tableConfiguration.getViewModelObjectName());
    }
    /**
     * if has view then response this
     * @return
     */
    public boolean generateViewResultMap(){
        if(isModelOnly){
            return true;
        }
        return stringHasValue(tableConfiguration.getViewModelObjectName());
    ...
    public boolean generateQueryCondition(){
        if (isModelOnly) {
            return false;
        }
        return tableConfiguration.isQueryConditionStatementEnabled();
    }
    public boolean generateExistCondition(){
        if (isModelOnly) {
            return false;
        }
        return tableConfiguration.isExistConditionStatementEnabled();
    }
