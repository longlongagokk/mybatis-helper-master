...
public class IbatorConfigurationParser {
    ...
    private void parseTable(Context context, Node node) {
        ...
        String enabledQueryConditionStatement = attributes.getProperty("enabledQueryConditionStatement"); //$NON-NLS-1$
        String enabledExistConditionStatement = attributes.getProperty("enabledExistConditionStatement"); //$NON-NLS-1$
        ...
        if(stringHasValue(enabledExistConditionStatement)){
            tc.setExistConditionStatementEnabled(isTrue(enabledExistConditionStatement));
        }
        if(stringHasValue(enabledQueryConditionStatement)){
            tc.setQueryConditionStatementEnabled(isTrue(enabledQueryConditionStatement));
        }
