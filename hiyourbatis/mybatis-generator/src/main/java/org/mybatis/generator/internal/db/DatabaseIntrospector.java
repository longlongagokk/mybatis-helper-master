...
public class DatabaseIntrospector {
    ...
    private Map<String,String> getLastLocalCatInfo(TableConfiguration tc)throws SQLException{
        String localCatalog;
        String localSchema;
        ...
        Map map = new HashMap();
        map.put("localCatalog",localCatalog);
        map.put("localSchema",localSchema);
        map.put("localTableName",localTableName);
        return map;
    }
    /**
    ...
    private Map<ActualTableName, List<IntrospectedColumn>> getColumns(
            ...
            Map<String,String> localCatInfo = getLastLocalCatInfo(tc);
            String localCatalog = localCatInfo.get("localCatalog");
            String localSchema = localCatInfo.get("localSchema");
            String localTableName = localCatInfo.get("localTableName");
    ...
    private List<IntrospectedTable> calculateIntrospectedTables(
        ...
        for (Map.Entry<ActualTableName, List<IntrospectedColumn>> entry : columns
            ...
            FullyQualifiedTable table = new FullyQualifiedTable(
                    ...
                    tc.getQueryModelObjectName(),
                    tc.getRequestModelObjectName(),
                    tc.getViewModelObjectName(),
                    tc.getAlias(),
            ...
            //获取table信息 whh 2018年3月9日21:21:01
            String tableRemarks = "";
            try {
                Map <String, String> localCatInfo = getLastLocalCatInfo(tc);
                ResultSet tableRs = databaseMetaData.getTables(localCatInfo.get("localCatalog"), localCatInfo.get("localSchema"), localCatInfo.get("localTableName"), null);
                while (tableRs.next()){
                    tableRemarks = tableRs.getString(5);
                }
            }catch (Exception e){
                e.printStackTrace();
            }
            ...
            IntrospectedTable introspectedTable = ObjectFactory
                    .createIntrospectedTable(tc, table, context,tableRemarks);
