...
public class XmlConstants {
    ...
    public static final String IBATIS2_SQL_MAP_CONFIG_SYSTEM_ID = "http://ibatis.apache.org/dtd/sql-map-application-2.dtd"; //$NON-NLS-1$
    ...
    public static final String MYBATIS3_MAPPER_CONFIG_SYSTEM_ID = "http://mybatis.org/dtd/mybatis-3-application.dtd"; //$NON-NLS-1$
