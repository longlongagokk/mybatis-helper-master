...
public class BaseRecordGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        topLevelClass.addImportedType(new FullyQualifiedJavaType("club.yourbatis.hi.annotation.Table"));
        ...
        topLevelClass.addImportedType(new FullyQualifiedJavaType("club.yourbatis.hi.annotation.Column"));
        for (IntrospectedColumn introspectedColumn : introspectedColumns) {
            ...
            if(introspectedColumn.isIdentity()){
                ...
                topLevelClass.addImportedType(new FullyQualifiedJavaType("com.vitily.mybatis.core.annotation.PrimaryKey"));
...
//            }
    ...
    private FullyQualifiedJavaType getSuperClass() {
        ...
        if (introspectedTable.getRules().generatePrimaryKeyClass()) {
            ...
            String rootClass = getRootClass();
            if (rootClass != null) {
                rootClass = rootClass + "<"+introspectedTable.getFullyQualifiedTable().getDomainObjectName()+">";
