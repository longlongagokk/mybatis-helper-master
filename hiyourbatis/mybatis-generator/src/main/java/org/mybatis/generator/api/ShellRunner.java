...
public class ShellRunner {
    ...
    public static void main(String[] args) {
        ...
        arguments.put(OVERWRITE, "Y");//默认给他加上
    ...
    public static void runConfigs(Map<String, String> arguments,String configfile){
        ...
        List<String> warnings = new ArrayList<String>();
         ...
         //configfile = arguments.get(CONFIG_FILE);
                //configfile = ShellRunner.class.getClass().getResource("/").toString().replace("file:", "")+"generatorConfig.xml";
                //configfile = ShellRunner.class.getClass().getResource("/").toString().replace("file:", "")+"generatorConfig-acae-sys.xml";
        //configfile = ShellRunner.class.getClass().getResource("/").toString().replace("file:", "")+"generatorConfig-hs.xml";
        //configfile = "F:\\lether2018\\MybatisGenerator\\src\\main\\resources\\generatorConfig22.xml";
