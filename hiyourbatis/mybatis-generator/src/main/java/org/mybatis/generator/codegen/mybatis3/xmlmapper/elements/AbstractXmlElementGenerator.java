...
public abstract class AbstractXmlElementGenerator extends AbstractGenerator {
    ...
    protected XmlElement existConditionElement(){
        XmlElement answer = new XmlElement("include"); //$NON-NLS-1$
        answer.addAttribute(new Attribute("refid",introspectedTable.getSqlExistsId()));
        return answer;
    }
    protected XmlElement queryConditionElement(){
        XmlElement answer = new XmlElement("include"); //$NON-NLS-1$
        answer.addAttribute(new Attribute("refid",introspectedTable.getSqlQueryConditionId()));
        return answer;
    }
    protected XmlElement selectForListTvSqlElement(){
        XmlElement answer = new XmlElement("include"); //$NON-NLS-1$
        answer.addAttribute(new Attribute("refid",introspectedTable.getSqlForListTvId()));
        return answer;
    }
