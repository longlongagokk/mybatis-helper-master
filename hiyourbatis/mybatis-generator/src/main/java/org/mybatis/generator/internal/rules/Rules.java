...
public interface Rules {
    ...
    boolean generateListResultMap();
    boolean generateViewResultMap();
    ...
    /**
     * Implements the rule for generating a Java product.  This rule is
     * only active when a javaClientGenerator configuration has been
     * specified, but the table is designated as "modelOnly".  Do not
     * generate the product if the table is designated as modelOnly.
     * 
     * @return true if the Java product should be generated
     */
    boolean generateJavaClient();

    boolean generateQueryCondition();
    boolean generateExistCondition();

//    boolean generateSelectForListTvSql();
//    boolean generateSelectByPrimaryKeyForTvSelect();
//    boolean generateGetMaxBeanSelect();
//    boolean generateGetCountPagingSelect();
//    boolean generateGetListByBeanSelect();
//    boolean generateExistSelect();
