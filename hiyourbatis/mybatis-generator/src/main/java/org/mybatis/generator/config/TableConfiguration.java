...
public class TableConfiguration extends PropertyHolder {
    ...
    private boolean queryConditionStatementEnabled;
    private boolean existConditionStatementEnabled;
    ...
    private String mapperAndServiceFileName;
    private String queryModelObjectName;
    private String requestModelObjectName;
    private String viewModelObjectName;
    private String alias;
    private ModelType modelType;
    private boolean wildcardEscapingEnabled;
    private String configuredModelType;
    private boolean delimitIdentifiers;
    private boolean generaterBlobsColumn;
    ...
    public TableConfiguration(Context context) {
        ...
        selectByExampleStatementEnabled = false;//默认不生成
        updateByPrimaryKeyStatementEnabled = true;//默认不生成
        deleteByPrimaryKeyStatementEnabled = false;//默认不生成
        deleteByExampleStatementEnabled = false;
        countByExampleStatementEnabled = false;//默认不生成
        updateByExampleStatementEnabled = false;//默认不生成

        queryConditionStatementEnabled = true;
        existConditionStatementEnabled = true;
        generaterBlobsColumn = false;
    ...
    public String getMapperAndServiceFileName() {
        return mapperAndServiceFileName;
    }

    public void setMapperAndServiceFileName(String mapperAndServiceFileName) {
        this.mapperAndServiceFileName = mapperAndServiceFileName;
    }
    ...
    public String getRequestModelObjectName() {
        return requestModelObjectName;
    }

    public TableConfiguration setRequestModelObjectName(String requestModelObjectName) {
        this.requestModelObjectName = requestModelObjectName;
        return this;
    }

    public String getViewModelObjectName() {
        return viewModelObjectName;
    }

    public void setViewModelObjectName(String viewModelObjectName) {
        this.viewModelObjectName = viewModelObjectName;
    }
    ...
    public XmlElement toXmlElement() {
        ...
        if(stringHasValue(mapperAndServiceFileName)){
            xmlElement.addAttribute(new Attribute(
                    "mapperAndServiceFileName", mapperAndServiceFileName)); //$NON-NLS-1$
        }
    ...
    public boolean isQueryConditionStatementEnabled() {
        return queryConditionStatementEnabled;
    }

    public void setQueryConditionStatementEnabled(boolean queryConditionStatementEnabled) {
        this.queryConditionStatementEnabled = queryConditionStatementEnabled;
    }

    public boolean isExistConditionStatementEnabled() {
        return existConditionStatementEnabled;
    }

    public void setExistConditionStatementEnabled(boolean existConditionStatementEnabled) {
        this.existConditionStatementEnabled = existConditionStatementEnabled;
    }

    public boolean isGeneraterBlobsColumn() {
        return generaterBlobsColumn;
    }

    public TableConfiguration setGeneraterBlobsColumn(boolean generaterBlobsColumn) {
        this.generaterBlobsColumn = generaterBlobsColumn;
        return this;
    }
}
